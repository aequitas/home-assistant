...
from homeassistant.components.climate import (
    ...
    ATTR_OPERATION_MODE, ATTR_SWING_MODE, SERVICE_SET_AUX_HEAT,
    SERVICE_SET_AWAY_MODE, SERVICE_SET_FAN_MODE, SERVICE_SET_HUMIDITY,
...
from homeassistant.const import (
    ...
    SERVICE_MEDIA_SEEK, SERVICE_OPEN_COVER, SERVICE_TURN_OFF, SERVICE_TURN_ON,
    SERVICE_UNLOCK, SERVICE_VOLUME_MUTE, SERVICE_VOLUME_SET,
