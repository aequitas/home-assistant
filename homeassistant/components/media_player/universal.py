...
from homeassistant.components.media_player import (
    ATTR_APP_ID, ATTR_APP_NAME, ATTR_INPUT_SOURCE, ATTR_MEDIA_ALBUM_ARTIST,
    ...
    ATTR_SUPPORTED_MEDIA_COMMANDS, DOMAIN, SERVICE_CLEAR_PLAYLIST,
...
from homeassistant.const import (
    ...
    SERVICE_TURN_OFF, SERVICE_TURN_ON, SERVICE_VOLUME_DOWN,
